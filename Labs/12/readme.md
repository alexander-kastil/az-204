...
![Architecture diagram depicting a user enhancing a web application by using the Azure Content Delivery Network](./_images/Lab12-Diagram.png)
...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and then select **Review + create**.
   ...
   | **Redundancy** drop-down list     | Select **Locally-redundant storage (LRS)**.                  |
    ...
    ![Screenshot displaying the configured settings on the Create a storage account blade](./_images/l12_create_a_storage_account.png)
...
1. On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Docker**:
    ...
    ![Screenshot displaying the configured settings on the Create Web App blade](./_images/l12_create_web_app.png)
...
1. On the **Docker** tab, perform the following actions, and then select **Review + create**:
    ...
    ![Screenshot displaying the configured settings on the Create Web App - Docker Tab](./_images/l12_create_web_app_docker.png)
...
1. In the Azure portal, select the **Cloud Shell** icon ![Cloud Shell icon](./_images/az204_lab_CloudShell.png) to open a new Bash session. If Cloud Shell defaults to a PowerShell session, select **PowerShell**, and in the drop-down menu, select **Bash**.
...
1. On the **CDN profile** blade, on the **Basics** tab, perform the following actions, and then select **Review + create**:
    ...
    ![Screenshot displaying the configured settings on the Create CDN profile blade.](./_images/l12_create_CDN_profile.png)
...
1. In the **Add an endpoint** pop-up dialog box, perform the following actions, and then select **Add**:
    ...
    ![Screenshot displaying the configured settings in the Add an endpoint dialog box.](./_images/l12_add_an_endpoint.png)
...
1. In the **Add an endpoint** pop-up dialog box, perform the following actions, and then select **Add**:
    ...
    ![Screenshot displaying the configured settings in the Add an endpoint dialog box.](./_images/l12_add_an_endpoint2.png)
...
1. In the **Add an endpoint** pop-up dialog box, perform the following actions, and then select **Add**:
    ...
    ![Screenshot displaying the configured settings in the Add an endpoint dialog box.](./_images/l12_add_an_endpoint3.png)
...
1. In the Azure portal, select the **Cloud Shell** icon ![Cloud Shell icon](./_images/az204_lab_CloudShell.png) to open a new Bash session. If Cloud Shell defaults to a PowerShell session, select **PowerShell**, and then in the drop-down menu, select **Bash**.
